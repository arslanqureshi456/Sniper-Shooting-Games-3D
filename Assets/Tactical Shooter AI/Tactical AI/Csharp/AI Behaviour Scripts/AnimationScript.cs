...
namespace TacticalAI
{
    public class AnimationScript : MonoBehaviour
    {
        ...
        public int forwardsMoveHash;
        public int sidewaysMoveHash;
        ...
        {
            GameManager.soldierAnimResetDelegate += ResetWalkingHashes;
        }
        ...
        public void ResetWalkingHashes()
        {
            Invoke("Delay", 0.3f);
        }
        void Delay()
