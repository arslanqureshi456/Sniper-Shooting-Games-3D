...
public class healthScriptInspector : Editor
{
    ...
    //ABDUL
    SerializedProperty dropWeaponProp;
    //SerializedProperty infiniteDecalProp;
    //SerializedProperty bloodFXProp;
    //SerializedProperty bloodAttachProp;
    ...
    void OnEnable()
    {
        ...
        //ABDUL
        dropWeaponProp = serializedObject.FindProperty("dropWeapon");
        //infiniteDecalProp = serializedObject.FindProperty("infiniteDecal");
        //bloodFXProp = serializedObject.FindProperty("bloodFX");
        //bloodAttachProp = serializedObject.FindProperty("bloodAttach");
    ...
    public override void OnInspectorGUI()
    {
        ...
        //ABDUL
        EditorGUILayout.PropertyField(dropWeaponProp);
        //infiniteDecalProp.boolValue = EditorGUILayout.Toggle("Infinite decal", infiniteDecalProp.boolValue);
        //EditorGUILayout.PropertyField(bloodFXProp);
        //EditorGUILayout.PropertyField(bloodAttachProp);
