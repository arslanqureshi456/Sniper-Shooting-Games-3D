...
public class GunScriptInspector : Editor
{
    ...
    SerializedProperty targetTrans;
    ...
    SerializedProperty muzzleFlashObjectProp;
    ...
    SerializedProperty weaponsContainer;
    ...
    void OnEnable()
    {
        ...
        targetTrans = serializedObject.FindProperty("targetTransform");
        ...
        muzzleFlashObjectProp = serializedObject.FindProperty("muzzleFlashObject");
        ...
        weaponsContainer = serializedObject.FindProperty("WeaponContainer");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(weaponsContainer, true);
        EditorGUILayout.PropertyField(isSniper, true);
        EditorGUILayout.PropertyField(sounds, true);
        EditorGUILayout.PropertyField(currentWeapon, true);
        EditorGUILayout.PropertyField(targetTrans, true);
        ...
        if (showFlashStuff)
        {
            ...
            EditorGUILayout.PropertyField(muzzleFlashObjectProp, true);
