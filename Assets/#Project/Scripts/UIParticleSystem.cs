    ...
    public class UIParticleSystem : MaskableGraphic
    {
        ...
        protected bool Initialize()
        {
            ...
            if (pSystem == null)
            {
                ...
                Shader foundShader = Shader.Find("Custom/Particles/Rain");
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                if (rotation == 0)
                {
                    ...
                    corner1.y = position.y - size / 3;
                    corner2.x = position.x + size;
                    corner2.y = position.y + size / 3;
                ...
                {
                    // apply rotation
                    Vector2 right = new Vector2(Mathf.Cos(rotation), Mathf.Sin(rotation)) * size / 3;
                    Vector2 up = new Vector2(Mathf.Cos(rotation90), Mathf.Sin(rotation90)) * size / 3;
        ...
        void SetPosition()
        {
            //if (parentWidth != -1)
            //{
                transform.GetComponent<RectTransform>().anchoredPosition = new Vector3(541.55f * parentImage.fillAmount, 6, 0);
            //}
        }
        void LateUpdate()
        {
