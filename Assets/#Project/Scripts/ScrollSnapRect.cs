...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    private void OnDisable()
    {
        if(_IsAds)
        {
            ...
            {
                if(PlayerPrefs.GetInt(links[i]) > 0)
                {
                    //Debug.Log(links[i] + "  " + PlayerPrefs.GetInt(links[i]));
                    //Analytics.CustomEvent(links[i], new Dictionary<string, object>
                    //{
                    //    {"V" + Application.version, PlayerPrefs.GetInt(links[i])}
                    //});
                    PlayerPrefs.SetInt(links[i], 0);
                }
            }
    ...
    void Start() {
        ...
        //if (transform.parent.GetComponent<InHouseAds>() != null)
        //{
        //    _IsAds = true;
        //    links = new string[_pageCount];
        //    string panelName, game, link;
        //    for (int i = 0; i < _pageCount; i++)
        //    {
        //        if(transform.name.Contains("01"))
        //            link = transform.parent.GetComponent<InHouseAds>().gameLinks[0];
        //        else if (transform.name.Contains("02"))
        //            link = transform.parent.GetComponent<InHouseAds>().gameLinks[1];
        //        else if (transform.name.Contains("03"))
        //            link = transform.parent.GetComponent<InHouseAds>().gameLinks[2];
        //        else if (transform.name.Contains("04"))
        //            link = transform.parent.GetComponent<InHouseAds>().gameLinks[3];
        //        else if (transform.name.Contains("05"))
        //            link = transform.parent.GetComponent<InHouseAds>().gameLinks[4];
        //        else
        //            link = transform.parent.GetComponent<InHouseAds>().gameLinks[5];
        //        if (link.Contains("mainmenu"))
        //            panelName = "MainMenu_";
        //        else if (link.Contains("setting"))
        //            panelName = "Setting_";
        //        else if (link.Contains("quit"))
        //            panelName = "Quit_";
        //        else if (link.Contains("gameplaypause"))
        //            panelName = "GameplayPause_";
        //        else if (link.Contains("gameplaysetting"))
        //            panelName = "GameplaySetting_";
        //        else if (link.Contains("gameplayfail"))
        //            panelName = "GameplayFail_";
        //        else// if (link.Contains("gameplaycomplete"))
        //            panelName = "GameplayComplete_";


        //        if (link.Contains(".sniper.professional"))
        //            game = "Sniper_";
        //        else if (link.Contains(".racing.ferocity"))
        //            game = "RacingFerocity_";
        //        else if (link.Contains("highway.traffic"))
        //            game = "CrazyCar_";
        //        else if (link.Contains(".mini.car.raceway"))
        //            game = "MiniCar_";
        //        else if (link.Contains("car.design.mechanic"))
        //            game = "CarMechanic_";
        //        else// if (link.Contains("lovepuzzlesgames"))
        //            game = "ADL_";


        //        links[i] = panelName + game + "Impression";
        //    }
        ...
        if (_IsAds)
        {
            PlayerPrefs.SetInt(links[_currentPage], PlayerPrefs.GetInt(links[_currentPage]) + 1);
        }
    }
