...
public class RagdollHelper : MonoBehaviour {
    ...
    public IEnumerator SlowMotion(float targetTimeScale, float duration)
    {
        while (Time.timeScale != targetTimeScale)
        {
            Time.timeScale = Mathf.MoveTowards(Time.timeScale, targetTimeScale, duration * Time.deltaTime);
            yield return null;
        }
    }
